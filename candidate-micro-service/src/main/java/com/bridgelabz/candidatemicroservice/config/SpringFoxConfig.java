...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.candidatemicroservice.controller"))
    ...
    private ApiInfo apiInfo(){
        return new ApiInfo("Candidate Micro Service",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("Candidate Micro Service","http://bridgelabz.com&quot;","m4anoj51@gmail.com"),
                "Apache 2.0",
