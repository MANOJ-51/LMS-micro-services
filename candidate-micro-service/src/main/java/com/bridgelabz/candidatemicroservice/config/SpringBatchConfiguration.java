...
public class SpringBatchConfiguration {
    ...
    private LineMapper<CandidateModel> lineMapper() {
        ...
        lineTokenizer.setNames("cicId","fullName","email","mobileNumber","hiredDate","degree","aggregatePercentage","city","state","preferredJobLocation","status","passedOutYear","candidateStatus");
