package com.bridgelabz.mentormicroservice.config;
...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.mentormicroservice.controller"))
    ...
    private ApiInfo apiInfo(){
        return new ApiInfo("Mentor Micro Service",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("Mentor Micro Service","http://bridgelabz.com&quot;","m4anoj51@gmail.com"),
                "Apache 2.0",
