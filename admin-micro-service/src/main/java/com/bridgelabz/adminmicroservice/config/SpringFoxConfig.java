package com.bridgelabz.adminmicroservice.config;
...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.adminmicroservice.controller"))
    ...
    private ApiInfo apiInfo(){
        return new ApiInfo("Admin Micro Service",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("Admin Micro Service","http://bridgelabz.com&quot;","m4anoj51@gmail.com"),
                "Apache 2.0",
